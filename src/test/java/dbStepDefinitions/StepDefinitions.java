...
public class StepDefinitions {
    ...
    public void kullanici_sutunundaki_verileri_okur(String field) throws SQLException {
        ...
        System.out.println(resultSet.getString(field)); //resultSet.next() nerede olursa olsun iterator'i bir sonraki elemente gecirir
